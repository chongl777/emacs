...
(function($){
    ...
    var updateWithData = function(data, grps, options, sp_url) {
        ...
        function tooltipTemplate(attrs, tooltip) {
            ...
            if (~attrs['className'].search("doc")) {
                ...
                attrs['Effective_x0020_Date'] = attrs['Effective_x0020_Date'] || d3.time.format("%Y-%m-%d")(attrs['Created']);
                ...
                attrs['t_date'] = d3.time.format('%Y-%m-%d')(new Date(attrs['t_date']));
                attrs['good_til_date'] = d3.time.format('%Y-%m-%d')(new Date(attrs['good_til_date']));
                html = Handlebars.compile(source)(attrs);
                tooltip.html(html);
                tooltip.select('#edit').on('click', function(e) {
                    ...
                    var ViewModel = function() {
                        ...
                        this.submit = function() {updateTarget.call(this, self, overlay);};
                        this.deleteRc = function() {deleteTarget.call(this, self, overlay);};
    ...
    function timelineDrawBack(data) {
        ...
        $('div.vis-labelset div.grp1.Security', self).on('click', function(e) {
            ...
            var ViewModel = function() {
                ...
                this.t_date = ko.observable(d3.time.format('%Y-%m-%d')(new Date()));
                ...
                this.submit = function() {submitNewTarget.call(this, self, overlay);};
                //this.valid = ko.pureComputed(valid_record, this);
                this.valid = ko.pureComputed(valid_record, this);
            }
            $("body").append(overlay);
    ...
    function submitNewTarget(tl, parent) {
        var data = this;
    ...
    function updateTarget(tl, parent) {
        var data = this;
        var closeFn = parent.removeDlg;
        parent.start_loading()
        $.ajax({
    ...
    function deleteTarget(tl, parent) {
        var data = this;
        var closeFn = parent.removeDlg;
        parent.start_loading()
        $.ajax({
