    ...
    var plot = $('#hist-plot', dlg).init_wfi_plot(
        {lines: {
         ...
         xaxis: {field: 'date',
                 ...
                 tooltipfmt: function(x) {return d3.time.format('%Y-%m-%d')(x)},
                 scale: d3.time.scale()},
...
var initialize_crude_total = function(PARAMS) {
    ...
    PARAMS['widget']['wow-summary-total'] = addTitle(
        $('div#wow-summary-total').init_wfi_table({
            ...
            processOption: function(data) {
                var self = this;
                var t_date = d3.time.format("%Y-%m-%dT00:00:00.000Z").parse(data[0]["last_date"]);
                self.title("OIL+PRODUCTS COMPARATIVE INVENTORY (AS OF " +
    ...
    PARAMS['widget']['wow-supply-demand-total'] = addTitle(
        $('div#wow-supply-demand-total').init_wfi_table({
            ...
            title: "OIL SUPPLY DEMOND BALANCE",
            columns_setup: [
                {data: "key",
                ...
                {data: "crrlvl",
                 ...
                 width: '20%',
                 render: function(value) {
                     return '<div class="value">' + d3.format(",f")(value) + '</div>';}},
    ...
    PARAMS['widget']['wow-supply-demand-total-ver2'] = addTitle(
        $('div#wow-supply-demand-total-ver2').init_wfi_table({
            ...
            title: "OIL SUPPLY DEMOND BALANCE (VER 2)",
            columns_setup: [
                {data: "key",
                 title: 'Supply Demand (kb/d)',
                 sortable: false,
    ...
    PARAMS['widget']['oil-wow-details-total'] = addTitle(
        $('div#oil-wow-details-total').init_wfi_table({
            ...
            processOption: function(data) {
                var self = this;
                var t_date = d3.time.format("%Y-%m-%dT00:00:00.000Z").parse(data[0]["nxt_week_date"]);
